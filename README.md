...
- Dynamic document variables for editorial folios, proof lines, URL text, and fitted sample copy: `<%lorem%>`, `<%project_title%>`, `<%page_title%>`, `<%page%>`, `<%pages%>`, `<%date%>`, `<%time%>`, `<%url:https://lp45.net%>`
