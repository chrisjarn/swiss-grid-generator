...
test("project transfers carry an explicit deterministic layout engine contract", () => {
  ...
  assert.match(transferSource, /visibilitySettings:\s*project\.visibilitySettings/)
  assert.match(sessionSource, /visibilitySettings:\s*ProjectVisibilitySettings/)
  assert.match(sessionSource, /resolveProjectVisibilitySettings\(\s*payload\.visibilitySettings/)
  assert.match(sessionSource, /resolveProjectVisibilitySettings\(legacyPageVisibilitySettings\)/)
