...
const helpSourcePath = path.join(repoRoot, "webapp/messages/en/help.md")
...
// This file is generated by webapp/scripts/generate-help-content.mjs from webapp/messages/en/help.md.
