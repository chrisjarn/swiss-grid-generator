...
import {
  ...
  loadOutlineFont,
  type OpenTypeFont,
} from "@/core/layout/font-outline"
import {
  getOpticalMarginAnchorOffset,
  resolveOpticalKerningPairAdjustment,
  type OpticalGlyphBounds,
} from "@/core/layout/optical-margin"
import { wrapTextDetailed, type WrappedTextLine } from "@/core/layout/text-layout"
import {
  resolveFontTrackingGraphemes,
  type ResolvedFormatTrackingGrapheme,
} from "@/core/layout/text-format-runs"
import { buildTrackingSegmentsForRenderedRange } from "@/core/layout/text-tracking-runs"
import {
  buildCanvasFont,
...
import { isLayoutProfilingEnabled, recordLayoutPerformanceMetric } from "@/core/layout/layout-performance"
import type {
  TextMeasureContext,
  TextMetricsEngine,
  TextWidthRequest,
