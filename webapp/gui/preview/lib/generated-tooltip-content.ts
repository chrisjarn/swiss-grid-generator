...
export const DOCUMENTATION_HOVER_INFO_ITEMS = [
  ...
  },
  {
    ...
    "blocks": [
      {
        "type": "paragraph",
        "text": "Use `Shift` + double-click on an empty module to create and select an image placeholder. Hold `1..4` with `Shift` to assign the active base-scheme swatch while creating it."
      },
      {
        "type": "paragraph",
