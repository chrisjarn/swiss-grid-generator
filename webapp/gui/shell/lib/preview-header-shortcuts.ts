...
export const PREVIEW_HEADER_SHORTCUTS: PreviewHeaderShortcut[] = [
  {
    id: "import_project",
    combo: "Cmd/Ctrl+O",
    description: translateMessage("ui.shell.shortcuts.importProject"),
    bindings: [{ key: "o" }],
  },
  {
    id: "save_to_library",
    combo: "Cmd/Ctrl+S",
    description: translateMessage("ui.shell.shortcuts.saveToLibrary"),
    bindings: [{ key: "s" }],
  },
  {
    id: "open_export",
    combo: "Cmd/Ctrl+Shift+E",
    description: translateMessage("ui.shell.shortcuts.exportDialog"),
    bindings: [{ key: "e", shift: true }],
  },
  {
    id: "undo",
    combo: "Cmd/Ctrl+Z",
    description: translateMessage("ui.shell.shortcuts.undo"),
    bindings: [{ key: "z" }],
  },
  {
    id: "redo",
    combo: "Cmd/Ctrl+Shift+Z or Cmd/Ctrl+Y",
    description: translateMessage("ui.shell.shortcuts.redo"),
    bindings: [{ key: "z", shift: true }, { key: "y" }],
  },
  {
    id: "toggle_dark_mode",
    combo: "Cmd/Ctrl+Shift+D",
    description: translateMessage("ui.shell.shortcuts.toggleDarkMode"),
    bindings: [{ key: "d", shift: true }],
  },
  {
    id: "toggle_baselines",
    combo: "Cmd/Ctrl+Shift+B",
    description: translateMessage("ui.shell.shortcuts.toggleBaselines"),
    bindings: [{ key: "b", shift: true }],
  },
  {
    id: "toggle_margins",
    combo: "Cmd/Ctrl+Shift+M",
    description: translateMessage("ui.shell.shortcuts.toggleMargins"),
    bindings: [{ key: "m", shift: true }],
  },
  {
    id: "toggle_modules",
    combo: "Cmd/Ctrl+Shift+G",
    description: translateMessage("ui.shell.shortcuts.toggleModules"),
    bindings: [{ key: "g", shift: true }],
  },
  {
    id: "toggle_typography",
    combo: "Cmd/Ctrl+Shift+T",
    description: translateMessage("ui.shell.shortcuts.toggleTypography"),
    bindings: [{ key: "t", shift: true }],
  },
  {
    id: "toggle_image_placeholders",
    combo: "Cmd/Ctrl+Shift+J",
    description: translateMessage("ui.shell.shortcuts.toggleImagePlaceholders"),
    bindings: [{ key: "j", shift: true }],
  },
  {
    id: "toggle_layers_panel",
    combo: "Cmd/Ctrl+Shift+P",
    description: translateMessage("ui.shell.shortcuts.toggleProjectPanel"),
  ...
  },
  {
    ...
    description: translateMessage("ui.shell.shortcuts.toggleLegalNotice"),
    bindings: [{ key: "3", shift: true }],
  },
  {
    id: "toggle_example_panel",
    combo: "Cmd/Ctrl+Shift+4",
    description: translateMessage("ui.shell.shortcuts.togglePresets"),
