...
- Available schemes, shown alphabetically with colors in effective bright-to-dark swatch order:
  - `BRAUN Classic`: `#f0ede5`, `#c5c3be`, `#8a8a87`, `#c02820`
...
- Holding `1..4` with `Shift` while double-clicking empty module creates an image placeholder in that swatch of the active base scheme.
